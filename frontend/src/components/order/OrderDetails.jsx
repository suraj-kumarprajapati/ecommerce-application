...
function OrderDetails() {
    ...
    const isPaid = paymentInfo?.status?.toString().toLowerCase() === "paid" ? true : false;
                    ...
                    <table className="table table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{shippingInfo?.address + ", " + shippingInfo?.city + ", " + shippingInfo?.state + " - " + + shippingInfo?.zipCode + ", " + shippingInfo?.country}</td>
                            </tr>
                        </tbody>
                    </table>
